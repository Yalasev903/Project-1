...
<body>
    ...
    <main>
        ...
        <section class="banner-area black-area pb-130">
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="banner__item">
                            ...
                            <div class="banner__content">
                                <h5 class="wow fadeInUp text-white" data-wow-delay=".1s"><img
                                        src="assets/images/icon/fire.svg" alt="icon"> GET <span
                                        class="primary-color">25% OFF</span> NOW
                                </h5>
                                <h1 class="wow fadeInUp text-white" data-wow-delay=".2s">Find everything <br>
        ...
        <section class="category-area black-area pb-130">
            <div class="container">
        ...
        <section class="ad-banner-area black-area">
                    ...
                    <div class="col-lg-6">
                        <div class="ad-banner__item">
                            ...
                            <div class="ad-banner__content left pt-130 pb-130">
                                <h2 class="mb-20 wow fadeInUp text-white" data-wow-delay=".1s">E-Liquids</h2>
                                <p class="wow fadeInUp text-white" data-wow-delay=".2s">Over 500+ flavour in our store
                                </p>
                    ...
                    <div class="col-lg-6">
                        <div class="ad-banner__item">
                            ...
                            <div class="ad-banner__content pt-130 pb-130 pl-65">
                                <h2 class="mb-20 wow fadeInDown text-white" data-wow-delay=".1s">E-Liquids</h2>
                                <p class="wow fadeInDown text-white" data-wow-delay=".2s">Over 500+ flavour in our store
                                </p>
        ...
        <section class="discount-area black-area bg-image pt-130" data-background="assets/images/bg/discount-bg.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="discount__item">
                            <div class="section-header">
                                <div class="section-title-icon wow fadeInUp" data-wow-delay=".1s">
                                    <span class="title-icon mr-10"></span>
                                    <h2 class="text-white">find your best favourite <br>
                                        flavour vapes</h2>
                                </div>
                                <p class="mt-30 wow fadeInUp text-white mb-55" data-wow-delay=".2s">Sell globally in
                                    minutes with
                                ...
                                <a class="off-btn wow text-white fadeInUp" data-wow-delay=".4s" href="#0"><img
        ...
        <section class="gallery-area black-area gallery-light">
        ...
        <section class="service-area service-light pt-130 pb-130">
            <div class="container">
                <div class="row g-4 align-items-center justify-content-center justify-content-lg-start">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service__item mb-50 wow fadeInUp" data-wow-delay=".1s">
                            <div class="service__icon">
                                <img src="assets/images/icon/feature-icon1l.png" alt="icon">
                            </div>
                        ...
                        <div class="service__item wow fadeInUp" data-wow-delay=".2s">
                            <div class="service__icon">
                                <img src="assets/images/icon/feature-icon2l.png" alt="icon">
                            </div>
                            <div class="service__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service__item mb-50 wow fadeInUp" data-wow-delay=".3s">
                            <div class="service__icon">
                                <img src="assets/images/icon/feature-icon3l.png" alt="icon">
                            </div>
                            <div class="service__content">
                        ...
                        <div class="service__item wow fadeInUp" data-wow-delay=".4s">
                            <div class="service__icon">
                                <img src="assets/images/icon/feature-icon4l.png" alt="icon">
                            </div>
                            <div class="service__content">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="image">
                                                    <img class="radius-10" src="assets/images/blog/blog-image2.png"
                                                        alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="image">
                                                    <img class="radius-10" src="assets/images/blog/blog-image3.png"
                                                        alt="image">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-4 d-block d-md-none d-xl-block">
                        <div class="blog__item-right">
                            <a href="blog-single.html" class="image d-block">
                                <img class="radius-10" src="assets/images/blog/blog-image-sm.png" alt="image">
                            </a>
